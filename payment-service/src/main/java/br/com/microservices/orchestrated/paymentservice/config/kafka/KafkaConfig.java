...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic startPaymentSuccessTopic(@Value("${spring.kafka.topic.payment-success}") String topicName) {
        return buildTopic(topicName);
    }

    @Bean
    public NewTopic startPaymentFailTopic(@Value("${spring.kafka.topic.payment-fail}") String topicName) {
        return buildTopic(topicName);
    }
