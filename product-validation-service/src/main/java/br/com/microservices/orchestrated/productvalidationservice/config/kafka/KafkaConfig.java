...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic startOrchestratorTopic(@Value("${spring.kafka.topic.orchestrator}") String topicName) {
        return buildTopic(topicName);
    }

    @Bean
    public NewTopic startProductValidationSuccessTopic(@Value("${spring.kafka.topic.product-validation-success}") String topicName) {
        return buildTopic(topicName);
    }

    @Bean
    public NewTopic startProductValidationFailTopic(@Value("${spring.kafka.topic.product-validation-fail}") String topicName) {
        return buildTopic(topicName);
    }
