...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic startSagaTopic(@Value("${spring.kafka.topic.start-saga}") String topicName) {
        return buildTopic(topicName);
    }

    @Bean
    public NewTopic startNotifyEndingTopic(@Value("${spring.kafka.topic.notify-ending}") String topicName) {
        return buildTopic(topicName);
    }
