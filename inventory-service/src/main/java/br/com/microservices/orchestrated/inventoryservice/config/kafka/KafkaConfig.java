...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic startInventorySuccessTopic(@Value("${spring.kafka.topic.inventory-success}") String topicName) {
        return buildTopic(topicName);
    }

    @Bean
    public NewTopic startInventoryFailTopic(@Value("${spring.kafka.topic.inventory-fail}") String topicName) {
        return buildTopic(topicName);
    }
